            ...
            <div class="d-flex"> 
                <?php
                    if(isLogin()) {
                        ...
                        echo<<<data
                            <div>
                                <a href="login" class="btn btn-outline-dark shadow-none me-lg-3 me-2"> Đăng nhập </a>
                                <a href="register" class="btn btn-outline-dark shadow-none me-lg-3 me-2"> Đăng kí </a>
                            </div>
                        data;
                    }
                ?>
