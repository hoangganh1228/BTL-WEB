        ...
        if(isPost()) {
            ...
            if(!empty($filterAll)) {
                ...
                if(!$this->model->isDuplicate('khach_hang', 'socancuoc', $filterAll['socancuoc'])) {
                        ...
                        if($filterAll['matkhau'] == $filterAll['xacnhanmk']) {
                            if(!empty($filterAll)) {
                                ...
                                if($insertStatus) {
                                    ...
                                    print_r($_SESSION);
                                    echo '</pre>';
                                    echo "<script>alert('cho len db thành công')</script>";
                                } else {
                                    echo "<script>alert('cho len db khong thành công')</script>";
                                }
                                redirect('index');
                            }
                        } else {
                            echo "<script>alert('2 mat khau khong trung nhau! Vui long nhap lai!')</script>";
                        }
                    } else {
                    ...
                    echo "<script>alert('trung cccd')</script>";
                }   
